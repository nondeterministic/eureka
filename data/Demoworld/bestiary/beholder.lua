...
do
   ...
   monster.attack = function() 
      ...
      if (monster.sp > 0) then
         dofile(simpl_datapath() .. "/bestiary/spells/stare.lua")
         cast_deadly_stare(monster)
      else
