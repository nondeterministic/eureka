...
do
   ...
   function img_path()
      return simpl_datapath() .. "/bestiary/demon.png"
   end
   ...
   function attack()
	 ...
	 simpl_printcon(string.format("A %s attempts to curse you, but misses.", get_name()), true)
      end
   ...
   function fight()
      simpl_printcon(string.format("A %s attempts a curse at you...", get_name()), true)
      sp = sp - 5
