...
do
   ...
   function otherwise(item)
	 ...
	 if (answer == "y") then
      ...
      elseif (string.find(item, "noise") or string(item, "night")) then
	 simpl_printcon("The last guests, who stayed here packed up their beds in fright the next morning. " ..
			"They claim that there are loud footsteps and some kind of grunting coming from the ground. I do not believe in such things though...")
      else
