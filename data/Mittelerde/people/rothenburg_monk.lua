...
do
   ...
   c_values = { 
      name = "Tuck", race = "HUMAN", ep = 0, hp = 10, hpm = 10, sp = 0, spm = 0, str = 7, luck = 15, dxt = 15, wis = 4, charr = 14, 
   ...
   function description()
      simpl_printcon("You see a monk with a brown robe and a big belly, drinking a beer and seemingly having dinner.")
   end

   function name()
      simpl_printcon("My name is Tuck.")
   end
   
   function job()
      simpl_printcon("Hehe, what does it look like, stranger? I'm a monk.")
   end
